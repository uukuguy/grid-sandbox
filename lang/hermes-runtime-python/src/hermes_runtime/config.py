...
class HermesRuntimeConfig:
    ...
    def from_env(cls, env_file: str | Path | None = None) -> "HermesRuntimeConfig":
        ...
        return cls(
            ...
            hermes_model=os.getenv("HERMES_MODEL", os.getenv("OPENAI_MODEL_NAME", "anthropic/claude-sonnet-4-20250514")),
            hermes_base_url=os.getenv("HERMES_BASE_URL", os.getenv("OPENAI_BASE_URL", "")),

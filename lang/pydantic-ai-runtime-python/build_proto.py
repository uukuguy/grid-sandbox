"""Build gRPC Python stubs from EAASP v2 proto files for pydantic-ai-runtime.

Mirrors ``lang/claude-code-runtime-python/build_proto.py`` but targets the
``pydantic_ai_runtime._proto`` package namespace.
...
OUT_DIR = Path(__file__).parent / "src" / "pydantic_ai_runtime" / "_proto"
...
PKG_PREFIX = "pydantic_ai_runtime._proto"

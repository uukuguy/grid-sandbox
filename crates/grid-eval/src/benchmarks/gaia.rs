...
mod tests {
    ...
    fn test_gaia_scoring() {
        ...
        let output = AgentOutput {
            messages: vec![grid_types::ChatMessage::assistant("FINAL ANSWER: 4")],
            ..Default::default()
        };
        ...
        let output_contains = AgentOutput {
            messages: vec![grid_types::ChatMessage::assistant("After analysis, the answer is 4.")],
            ..Default::default()
        };

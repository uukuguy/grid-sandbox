...
pub struct TaskRecord {
    pub id: String,
    pub prompt: String,
    pub tools: Option<Vec<grid_types::tool::ToolSpec>>,
...
impl EvalTask for TaskRecord {
    ...
    fn available_tools(&self) -> Option<Vec<grid_types::tool::ToolSpec>> { self.tools.clone() }
...
impl ComparisonRunner {
    ...
    pub async fn run_comparison_with_providers(
        models: Vec<(ModelInfo, Arc<dyn grid_engine::providers::Provider>)>,
        tasks: &[Box<dyn EvalTask>],
        config: &MultiModelConfig,
    ) -> Result<ComparisonReport> {
        let mut model_reports = Vec::new();
...
mod tests {
    ...
    fn test_task_record_gaia_scoring_dispatch() {
        ...
        let output_pass = AgentOutput {
            messages: vec![grid_types::ChatMessage::assistant("The answer is 4.")],
            ..Default::default()
        };
        ...
        let output_noresp = AgentOutput {
            messages: vec![grid_types::ChatMessage::assistant("(no response)")],
            ..Default::default()
        };
    ...
    fn test_task_record_swe_bench_scoring_dispatch() {
        ...
        let output_fail = AgentOutput {
            messages: vec![grid_types::ChatMessage::assistant("I can't fix this")],
            ..Default::default()
        };
        let score_fail = tr.score(&output_fail);
    ...
    fn test_task_record_tau_bench_scoring_dispatch() {
        ...
        let output_pass = AgentOutput {
            messages: vec![grid_types::ChatMessage::assistant("Done")],
            tool_calls: vec![
    ...
    fn test_task_record_fallback_generic_scoring() {
        ...
        let output_pass = AgentOutput {
            messages: vec![grid_types::ChatMessage::assistant("result")],
            tool_calls: vec![
        ...
        // Fail: no tool calls
        let output_fail = AgentOutput {
            messages: vec![grid_types::ChatMessage::assistant("just text")],
            ..Default::default()
        };

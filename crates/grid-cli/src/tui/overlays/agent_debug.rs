...
fn render_conversation_preview(state: &TuiState, frame: &mut Frame, area: Rect) {
    ...
    for msg in state.messages.iter().skip(start) {
        let role_label = match msg.role {
            grid_types::message::MessageRole::User => ("You", Color::Cyan),
            grid_types::message::MessageRole::Assistant => ("AI", Color::Green),
            grid_types::message::MessageRole::System => ("Sys", Color::Yellow),
        };
        ...
        let summary: String = msg
            ...
            .iter()
            .find_map(|b| match b {
                grid_types::message::ContentBlock::Text { text } => {

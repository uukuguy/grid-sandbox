...
use super::run_mode::GridRunMode;
...
impl ExecutionTargetResolver {
    ...
    pub fn run_mode(&self) -> GridRunMode {
        self.run_mode
    }
    ...
    pub fn resolve(&self, category: ToolCategory) -> (ExecutionTarget, String) {
        ...
        if self.run_mode.is_local_execution() {
            return (
                ...
                "GridRunMode=Sandboxed: container provides isolation".to_string(),
            );
        }

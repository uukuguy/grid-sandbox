...
mod tests {
    ...
    async fn test_get_thread_messages_order() {
        ...
        assert_eq!(messages[0].role, grid_types::MessageRole::User);
        assert_eq!(messages[1].role, grid_types::MessageRole::Assistant);
        assert_eq!(messages[2].role, grid_types::MessageRole::User);
        assert_eq!(messages[3].role, grid_types::MessageRole::Assistant);
    }

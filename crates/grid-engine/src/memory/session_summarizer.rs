...
use grid_types::{ChatMessage, CompletionRequest, ContentBlock};
    ...
    fn build_conversation_summary(messages: &[ChatMessage]) -> String {
        ...
        for msg in messages {
            let role = match msg.role {
                ...
                grid_types::MessageRole::System => continue, // skip system messages
            };
...
mod tests {
    ...
    fn test_build_conversation_summary_skips_system() {
        let messages = vec![ChatMessage {
            role: grid_types::MessageRole::System,

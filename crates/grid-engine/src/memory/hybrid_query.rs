...
impl HybridQueryEngine {
    ...
    async fn maybe_rerank(
        ...
        let entries: Vec<grid_types::memory::MemoryEntry> = results
            .iter()
...
fn hybrid_result_to_memory_entry(r: &HybridSearchResult) -> grid_types::memory::MemoryEntry {
    grid_types::memory::MemoryEntry {
        id: grid_types::memory::MemoryId::from_string(r.id.clone()),
        user_id: String::new(),
        sandbox_id: String::new(),
        category: grid_types::memory::MemoryCategory::Profile,
        content: r.content.clone(),
        metadata: serde_json::json!({}),
        embedding: None,
        importance: 1.0,
        access_count: 0,
        source_type: grid_types::memory::MemorySource::Manual,
        source_ref: String::new(),
        ttl: None,
        timestamps: grid_types::memory::MemoryTimestamps {
            created_at: 0,
            updated_at: 0,
            accessed_at: 0,
        },
        memory_type: grid_types::memory::MemoryType::default(),
        session_id: None,
        event_data: None,
    }
}

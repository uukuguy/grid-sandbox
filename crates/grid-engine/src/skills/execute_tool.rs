...
use grid_types::skill::ExecutionMode;
use grid_types::{ToolContext, ToolOutput, ToolSource};
...
pub struct SubAgentContext {
    ...
    pub model: String,
    pub user_id: grid_types::UserId,
    pub sandbox_id: grid_types::SandboxId,
    pub tool_ctx: Option<grid_types::ToolContext>,
...
impl Tool for ExecuteSkillTool {
    ...
    fn risk_level(&self) -> grid_types::RiskLevel {
        grid_types::RiskLevel::HighRisk
    }
...
impl ExecuteSkillTool {
    ...
    async fn execute_playbook(
        &self,
        skill: &grid_types::SkillDefinition,
        request: &str,
    ) -> Result<ToolOutput> {

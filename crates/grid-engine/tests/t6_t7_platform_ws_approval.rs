...
use grid_engine::tools::approval::{ApprovalGate, ApprovalManager, ApprovalPolicy};
...
async fn approval_manager_with_gate_full_cycle() {
    ...
    assert!(
        matches!(decision, grid_engine::tools::approval::ApprovalDecision::NeedsApproval { .. }),
...
async fn approval_manager_dev_mode_skips_gate() {
    ...
    assert_eq!(
        decision,
        grid_engine::tools::approval::ApprovalDecision::Approved,

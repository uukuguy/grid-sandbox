...
use grid_types::id::SandboxId;
use grid_types::{SkillDefinition, SkillSourceType, ToolContext, TrustLevel};
...
async fn test_skill_tool_source() {
    ...
    match tool.source() {
        grid_types::ToolSource::Skill(name) => assert_eq!(name, "test-skill"),

...
pub struct CreateTaskRequest {
    pub name: String,
    pub cron: String,
    pub agent_config: grid_engine::scheduler::AgentTaskConfig,
...
pub struct UpdateTaskRequest {
    ...
    pub agent_config: Option<grid_engine::scheduler::AgentTaskConfig>,
    pub enabled: Option<bool>,
}
...
impl From<grid_engine::scheduler::ScheduledTask> for TaskResponse {
    fn from(t: grid_engine::scheduler::ScheduledTask) -> Self {
        Self {
            id: t.id,
            user_id: t.user_id,
            name: t.name,
...
impl From<grid_engine::scheduler::TaskExecution> for ExecutionResponse {
    fn from(e: grid_engine::scheduler::TaskExecution) -> Self {
        Self {
            id: e.id,
            task_id: e.task_id,
